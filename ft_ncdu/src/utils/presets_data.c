...
const char				*g_shell_exports[] = {
	"# === 1337 / 42 Goinfre Quota Bypass (ft_ncdu paths v2) ===",
	...
	"export HF_HOME=\"$GOINFRE_USER/.cache/huggingface\"",
	"export TORCH_HOME=\"$GOINFRE_USER/.cache/torch\"",
	"export TRITON_CACHE_DIR=\"$GOINFRE_USER/.cache/triton\"",
	"export PIP_CACHE_DIR=\"$GOINFRE_USER/.cache/pip\"",
	"export UV_CACHE_DIR=\"$GOINFRE_USER/.cache/uv\"",
	"export OLLAMA_MODELS=\"$GOINFRE_USER/.ollama/models\"",
	"export CARGO_HOME=\"$GOINFRE_USER/.cargo\"",
	"export RUSTUP_HOME=\"$GOINFRE_USER/.rustup\"",
	"export DOCKER_CONFIG=\"$GOINFRE_USER/.docker\"",
	"export NPM_CONFIG_CACHE=\"$GOINFRE_USER/.npm\"",
